...
export default function SidebarComponent() {
  return (
    <div className="h-screen p-5 bg-white shadow-xl ">
      {/* logo */}
      <div className="flex items-center gap-3 border-b-2 border-b-gray-200">
        <img
      ...
      {/* sidebar list */}
      <div className="flex flex-col justify-between w-full p-4 min-h-11/12">
        ...
        {/* render log out */}
        <div className="flex items-start gap-3 px-5 py-3 cursor-pointer rounded-xl hover:bg-gray-200">
          <LogOutIcon />
